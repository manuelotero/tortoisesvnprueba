...
public class CreateASubscriptionGroupAndAccessCode extends MyProjPage{
	...
	public CreateASubscriptionGroupAndAccessCode goToSubscriptionManager(){
		subcriptionManagerLink.click();
		return this;
	}
	
	public CreateASubscriptionGroupAndAccessCode goToIntitution(){
		institutoAutoLink.click();
		return this;
	}
	
	public CreateASubscriptionGroupAndAccessCode goToUsageStantsGroupsLink(){
		usageStantsGroupsLink.click();
		return this;
	}
	
	public CreateASubscriptionGroupAndAccessCode goToAddGruop(){
		addGroup.click();
		groupName.clear();
	...
	public CreateASubscriptionGroupAndAccessCode createGruop(){
		createGroup.click();
		return this;
	}
	
	public CreateASubscriptionGroupAndAccessCode deleteGroup(){
		deleteButtton.click();
		acceptDelete.click();
		return this;
	}
	...
	@Override
	public CreateASubscriptionGroupAndAccessCode then() {
		return this;
	}

	@Override
	public CreateASubscriptionGroupAndAccessCode and() {
		return this;
	}

	public CreateASubscriptionGroupAndAccessCode and(UI uiInstance) {
